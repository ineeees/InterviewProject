// introduction 
This project is a Flask application where i used Docker to create its image and run it through a container.
...
7- Access to the application via : http://127.0.0.1:5000 where you can automatically try the query http://127.0.0.1:5000/api/stats?ticker=MSFT&start=2023-01-01&end=2023-12-31
